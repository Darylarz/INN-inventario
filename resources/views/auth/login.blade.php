...
@section('content')
<div class="relative min-h-screen w-full m-0 p-0 bg-gray-100 dark:bg-gray-900">

    <!-- Imagen de fondo full screen -->
    <div class="absolute top-0 left-0 w-full h-full" >
        <img src="{{ asset('images/login-fondo.jpg') }}" 
             alt="Fondo Login"
             class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/30 dark:bg-black/50"></div> <!-- Overlay -->
    </div>

    <!-- Contenedor del formulario centrado -->
    <div class="relative flex items-center justify-center min-h-screen">
        <div class="w-full max-w-md bg-white/90 dark:bg-gray-800/90 rounded-lg shadow-md p-6 backdrop-blur-sm">
