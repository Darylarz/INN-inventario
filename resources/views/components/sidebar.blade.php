<aside id="sidebar" class="fixed top-0 left-0 z-30 w-64 h-screen transition-transform bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-lime-100 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li class="pt-4">
                <a href="{{ route('inventario.index') }}" class="flex items-center justify-between p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Inicio</span>
            ...
            <li>
                <a href="{{ route('ubicaciones.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Ubicaciones</span>
                </a>
            </li>
            @endcan
            @can('usuario crear')
            <li>
                <a href="{{ route('categorias.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Categorías</span>
                </a>
            </li>
            @endcan
            ...
            <li>
                <a href="{{ route('reportes.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Reportes</span>
                </a>
            </li>
            @endcan
            ...
            <li>
                <a href="{{ route('admin.users') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Usuarios</span>
                </a>
            </li>
            @endcan
            @can('usuario crear')
            <li>
                <a href="{{ route('inventario.disabled') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                    </svg>
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Desincorporados</span>
                </a>
            </li>
            @endcan
             ...
             @can('usuario crear')
            <li>
                <a href="{{ route('logcat.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 2a6 6 0 0 0-6 6c0 4.5 6 10 6 10s6-5.5 6-10a6 6 0 0 0-6-6Zm0 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4Z" />
                    </svg>
                    <span class="flex-1 ms-3 text-black whitespace-nowrap">Logcat</span>
                </a>
            </li>
            @endcan
        </ul>
