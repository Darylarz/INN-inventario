<div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-6">
  <h2 class="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Editar artículo</h2>
  ...
  <form wire:submit.prevent="submit" class="space-y-4">
    ...
    <div class="flex justify-between items-center">
      <a href="{{ route('inventario-index') }}" class="text-sm text-gray-600 hover:underline">Cancelar</a>
