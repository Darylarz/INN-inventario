...
<div class="container mx-auto p-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('inventario.index') }}" class="px-3 py-2 text-sm bg-gray-100 border rounded hover:bg-gray-200">Volver</a>
    </div>
    ...
    <div class="bg-white border rounded p-4 shadow-sm">
        <form action="{{ route('reportes.pdf') }}" method="POST" target="_blank" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="tipo_item" class="w-full border rounded px-3 py-2">
