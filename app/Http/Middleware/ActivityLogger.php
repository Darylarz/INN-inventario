    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        try {
            ...
            ActivityLog::create([
                ...
                'subject_type' => optional($request->route())->getActionMethod() ? $request->route()->getName() : null,
                'subject_id' => $request->route('id') ?? $request->route('inventario') ?? null,
                'description' => json_encode($this->safePayload($request)),
                'ip' => $request->ip(),
